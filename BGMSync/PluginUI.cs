...
internal sealed class PluginUI : Window, IDisposable
{
    ...
    public override void Draw()
    {
        ...
        if (ImGui.BeginTabBar("##tabs"))
        {
            ...
            { DrawSongBrowserTab(); ImGui.EndTabItem(); }
    ...
    private void DrawSongBrowserTab()
    {
        ImGui.TextUnformatted($"{SongList.Instance.GetSongs().Count} songs loaded.");
        ImGui.SameLine();
        ImGui.TextDisabled("Double-click to map to current territory. Preview to test.");
